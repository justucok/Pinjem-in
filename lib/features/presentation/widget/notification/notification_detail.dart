        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                PinjamMobilFormTitle(title: type == 'Car' ? 'Tujuan' : 'Acara'),
                const SizedBox(
                  height: 5,
                ),
                ...
                Row(
                  children: [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        PinjamMobilFormTitle(
                          title: type == 'Car' ? 'Penumpang' : 'Peserta',
                        ),
                        const SizedBox(
                          height: 5,
                        ),
          ...
          Container(
            ...
            child: status == 'Diterima'
                ? type == 'Car'
                    ? BlocBuilder<CarByIdBloc, CarByIdState>(
                        bloc: carByIdBloc..add(LoadCarById(id: '$carId')),
                        builder: (context, state) {
                          if (state is CarByIdSuccess) {
                            final data = state.carByIdData;
                            log(data.picture);
                            return Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
